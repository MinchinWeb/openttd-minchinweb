/*	Minchinweb's MetaLibrary v.1 r.112 [2011-04-26],  
...
class MinchinWeb extends AILibrary {
	...
	function GetDescription() { return "Minchinweb's MetaLibrary containing a Road Pathfinder, a Ship Pathfinder, a 'Line Walker,' a 'Spiral Walker,' a 'Waterbody Check,' Array functions, an A* implimentation, and a Fibonacci Heap implementation. (v.1, r.112)"; }
