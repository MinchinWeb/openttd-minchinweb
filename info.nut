...
class WmDOT extends AIInfo 
{
	...
	function GetSettings() {
		...
		AddSetting({name = "info3", description = "--  Operation DOT  ------------------------------------", min_value = 0, max_value = 1, easy_value = 0, medium_value = 0, hard_value = 0, custom_value = 0, flags = 0});
		AddLabels("info3", {_0 = "", _1 = ""});
