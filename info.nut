...
class WmDOT extends AIInfo 
{
	...
	function GetDescription()   { return "An AI that doesn't compete with you but rather builds out the highway network. We're still looking for a revenue stream. v.6 (r.118)"; }
...
//	function GetURL()			{ return "http://code.google.com/p/openttd-noai-wmdot/issues/"; }
	...
	function GetSettings() {
		...
		AddSetting({name = "OpDOT_RebuildAttempts", description = "     Build Attemps", min_value = 1, max_value = 20, easy_value = 10, medium_value = 10, hard_value = 10, custom_value = 10, flags = AICONFIG_INGAME});
