...
class WmDOT extends AIInfo 
{
	...
	function GetDescription()   { return "An AI that doesn't compete with you but rather builds out the highway network. We're still looking for a revenue stream. v.5 (r.64)"; }
...
//	function GetURL()			{ return "http://code.google.com/p/openttd-noai-wmdot/issues/"; }
	...
	function GetSettings() {
		...
		AddSetting({name = "OpDOT_RebuildAttempts", description = "     Rebuild Attemps", min_value = 1, max_value = 15, easy_value = 2, medium_value = 2, hard_value = 2, custom_value = 2, flags = AICONFIG_INGAME});
