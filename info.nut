...
class WmDOT extends AIInfo 
{
	...
	function GetDescription()   { return "An AI that doesn't compete with you but rather builds out the highway network. We're still looking for a revenue stream. v.6 (r.116)"; }
	function GetVersion()       { return 6; }
	function MinVersionToLoad() { return 1; }
	function GetDate()          { return "2011-04-27"; }
...
//	function GetURL()			{ return "http://code.google.com/p/openttd-noai-wmdot/issues/"; }
	...
	function GetSettings() {
		...
		AddSetting({name = "Debug_Level", description = "Debug Level ", min_value = 0, max_value = 5, easy_value = 0, medium_value = 0, hard_value = 0, custom_value = 0, flags = AICONFIG_INGAME});
		...
		AddSetting({name = "OpDOT_RebuildAttempts", description = "     Build Attemps", min_value = 1, max_value = 15, easy_value = 2, medium_value = 2, hard_value = 2, custom_value = 2, flags = AICONFIG_INGAME});
